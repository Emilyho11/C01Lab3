...
function App() {
  ...
  const deleteNote = async (entry) => {
    ...
    try {
      ...
      console.log("Deleting the note failed:", error);
      alert("An error occurred to delete the note.");
    }
  };
  ...
  const deleteAllNotes = async () => {
    ...
    try {
      ...
      alert("An error occurred to delete all notes.");
    }
  };
  ...
  const deleteNoteState = (_id) => {
    ...
    const result = notes.filter((note) => note._id !== _id);
    setNotes(result);
  };
